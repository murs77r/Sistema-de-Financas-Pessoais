function atualizarSaldoContas_1234() {
    ...
    tabela1Data_7890.forEach(rowTabela1_4567 => {
        ...
        } else if (habilitacaoInvestimentos_6789 === "Sim" && instituicaoTabela1_8901 !== "Caixa Econômica Federal") {
        ...
        } else if (instituicaoTabela1_8901 === "Caixa Econômica Federal") {
            criarLinhaTabela2_1234(tabela2Sheet_3456, rowTabela1_4567, "Movimentação");
            criarLinhaTabela2_1234(tabela2Sheet_3456, rowTabela1_4567, "Investimentos");
            Logger.log(`Instituição: ${instituicaoTabela1_8901}, Tipo: ${tipoContaTabela1_2345}, Habilitação para Investimentos: Sim, Criando linhas para Movimentação e Investimentos.`);
            criarLinhaTabela2_1234(tabela2Sheet_3456, rowTabela1_4567, "Cesta-Alimentação");
            Logger.log(`Instituição: ${instituicaoTabela1_8901}, Tipo: ${tipoContaTabela1_2345}, Criando linha para Cesta-Alimentação.`);
            criarLinhaTabela2_1234(tabela2Sheet_3456, rowTabela1_4567, "Auxílio-Refeição");
            Logger.log(`Instituição: ${instituicaoTabela1_8901}, Tipo: ${tipoContaTabela1_2345}, Criando linha para Auxílio-Refeição.`);
        } else {
            criarLinhaTabela2_1234(tabela2Sheet_3456, rowTabela1_4567, "Movimentação");
...
function criarLinhaTabela2_1234(tabela2Sheet_3456, rowTabela1_4567, categoria_7890) {
    ...
    const formula_9012 = `=SWITCH(INDIRECT("C" & ROW()); "Movimentação"; IFERROR((SUMIFS('Transações com Saldo'!$Y$2:$Y;'Transações com Saldo'!$R$2:$R;INDIRECT("A" & ROW());'Transações com Saldo'!$S$2:$S;"Movimentação";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!$B$2:B;"<>""Movimentação entre Contas")+(SUMIFS('Transações com Saldo'!$X$2:$X;'Transações com Saldo'!$R$2:$R;INDIRECT("A" & ROW());'Transações com Saldo'!$S$2:$S;"Movimentação";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!$B$2:B;"Movimentação entre Contas")*-1)+SUMIFS('Transações com Saldo'!$X$2:$X;'Transações com Saldo'!$T$2:$T;INDIRECT("A" & ROW());'Transações com Saldo'!$U$2:$U;"Movimentação";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!B$2:$B;"<>Saldo Anterior"));0); "Investimentos"; IFERROR(SUMIFS('Investimentos Ativos'!$H$2:$H;'Investimentos Ativos'!$F$2:$F;INDIRECT("A" & ROW()));0)+IFERROR((SUMIFS('Transações com Saldo'!$Y$2:$Y;'Transações com Saldo'!$R$2:$R;INDIRECT("A" & ROW());'Transações com Saldo'!$S$2:$S;"Investimentos";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!$B$2:B;"<>""Movimentação entre Contas")+(SUMIFS('Transações com Saldo'!$X$2:$X;'Transações com Saldo'!$R$2:$R;INDIRECT("A" & ROW());'Transações com Saldo'!$S$2:$S;"Investimentos";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!$B$2:B;"Movimentação entre Contas")*-1)+SUMIFS('Transações com Saldo'!$X$2:$X;'Transações com Saldo'!$T$2:$T;INDIRECT("A" & ROW());'Transações com Saldo'!$U$2:$U;"Investimentos";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!B$2:$B;"<>Saldo Anterior"));0); "Cesta-Alimentação"; IFERROR((SUMIFS('Transações com Saldo'!$Y$2:$Y;'Transações com Saldo'!$R$2:$R;INDIRECT("A" & ROW());'Transações com Saldo'!$S$2:$S;"Cesta-Alimentação";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!$B$2:B;"<>""Movimentação entre Contas")+(SUMIFS('Transações com Saldo'!$X$2:$X;'Transações com Saldo'!$R$2:$R;INDIRECT("A" & ROW());'Transações com Saldo'!$S$2:$S;"Cesta-Alimentação";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!$B$2:B;"Movimentação entre Contas")*-1)+SUMIFS('Transações com Saldo'!$X$2:$X;'Transações com Saldo'!$T$2:$T;INDIRECT("A" & ROW());'Transações com Saldo'!$U$2:$U;"Cesta-Alimentação";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!B$2:$B;"<>Saldo Anterior"));0); "Auxílio-Refeição"; IFERROR((SUMIFS('Transações com Saldo'!$Y$2:$Y;'Transações com Saldo'!$R$2:$R;INDIRECT("A" & ROW());'Transações com Saldo'!$S$2:$S;"Auxílio-Refeição";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!$B$2:B;"<>""Movimentação entre Contas")+(SUMIFS('Transações com Saldo'!$X$2:$X;'Transações com Saldo'!$R$2:$R;INDIRECT("A" & ROW());'Transações com Saldo'!$S$2:$S;"Auxílio-Refeição";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!$B$2:B;"Movimentação entre Contas")*-1)+SUMIFS('Transações com Saldo'!$X$2:$X;'Transações com Saldo'!$T$2:$T;INDIRECT("A" & ROW());'Transações com Saldo'!$U$2:$U;"Auxílio-Refeição";'Transações com Saldo'!$G$2:G;"Efetuado";'Transações com Saldo'!B$2:$B;"<>Saldo Anterior"));0); "ERRO")`;
